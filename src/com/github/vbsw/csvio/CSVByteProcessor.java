...
/**
 * Template for processing lines as byte array.
 * 
 * @author Vitali Baumtrok
 */
public abstract class CSVByteProcessor {
	 ...
	 */
	public abstract void processLine ( final byte[] bytes, final int fromLeft, final int toRight, final int lineNumber, final int bytesReadTotal );
